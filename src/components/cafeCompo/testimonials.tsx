  ...
  return (
    <section className="text-gray-600 body-font ">
      <div className="container px-5 py-24 mx-auto">
        <h1 className="text-3xl font-medium title-font text-Org mb-12 text-center">Testimonials</h1>
        <div className="flex flex-wrap -m-4">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-white px-10 py-12 rounded cafe-testimonials">
                ...
                <p className="leading-relaxed mb-6 text-black">{testimonial.content}</p>
                <a className="inline-flex items-center">
                  <img alt="testimonial" src={testimonial.imageSrc} className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
